            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="relative p-6 flex-auto mx-10">
                    <div class="mb-4">
                        ...
                        <input name="email" class="appearance-none border border-gray-300 rounded-lg w-full py-3 px-4 placeholder-serv-text text-xs" id="email" type="email" placeholder="name@domain.com" autofocus required>
