        ...
        <div class="hero">
            <div class="mx-auto flex pt-16 pb-16 lg:pb-20 lg:px-24 md:px-16 sm:px-8 px-8 lg:flex-row flex-col">
                ...
                <div class="w-full lg:w-1/2 text-center lg:justify-start justify-center flex pr-0">
                    <img class="bottom-0 lg:block lg:right-24 md:right-16 sm:right-8 right-8 w-75" src="{{ asset('/assets/hero-image.png') }}" alt="hero" />
                </div>
            </div>

            <div class="lg:mb-20 mb-10 flex sm:space-x-4 space-x-1">
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="{{ asset('/assets/images/brand-logo/netflix.svg') }}" alt="netflix">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="{{ asset('/assets/images/brand-logo/amazon.svg') }}" alt="amazon">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="{{ asset('/assets/images/brand-logo/uber.svg') }}" alt="uber">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="{{ asset('/assets/images/brand-logo/grab.svg')}}" alt="grab">
                </div>
                <div class="flex-1 flex items-center justify-center py-3 px-6">
                    <img src="{{ asset('/assets/images/brand-logo/google.svg') }}" alt="google">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="py-10 lg:py-24 flex lg:flex-row flex-col items-center cta-bg">
            ...
            <div class="w-full lg:w-1/2 text-center justify-center flex lg:mb-0 mb-12">
                <a href="{{ url('https://www.youtube.com/watch?v=dQw4w9WgXcQ') }}" data-lity>
                    <img id="hero" src="{{ asset('/assets/images/video-placeholder.png') }}" alt="video" class="p-5" />
                </a>
            </div>
            <!-- Right Column -->
