                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_service as $item)
                                                <input placeholder="Keunggulan" type="text" name="{{ ('advantage-services['.$item->id.']') }}" id="advantage-services" autocomplete="advantage-services" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $item->advantage ?? '' }}" required>
                                            @empty
                                                <input placeholder="Keunggulan 1" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>

                                                <input placeholder="Keunggulan 2" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>

                                                <input placeholder="Keunggulan 3" type="text" name="advantage-service[]" id="advantage-service" autocomplete="advantage-service" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                            @endforelse
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                                ...
                                                <option value="2" {{ $service->revision_limit == '2' ? 'selected' : '' }}>2</option>
                                                <option value="5" {{ $service->revision_limit == '5' ? 'selected' : '' }}>5</option>
                                                <option value="7" {{ $service->revision_limit == '7' ? 'selected' : '' }}>7</option>
                                                <option value="10" {{ $service->revision_limit == '10' ? 'selected' : '' }}>10</option>
                                                <option value="12" {{ $service->revision_limit == '12' ? 'selected' : '' }}>12</option>
                                            </select>
                                        </div>
                                            ...
                                            <div class="grid grid-cols lg:grid-cols-3 md:grid-cols-2 gap-4">
                                                @forelse ($thumbnail as $item)
                                                    <div class="mb-2">
                                                        ...
                                                        <input placeholder="Thumbnail" type="file" name="{{ 'thumbnails['.$item->id.']' }}" id="thumbnails" autocomplete="thumbnails" class="block w-full py-3 pl-5 mt-3 border-gray-300 rounded-md shadow-sm focus:ring-green-500 sm:text-sm">
                                                    </div>
                                                @empty
                                                    <input placeholder="Thumbnail 1" type="file" name="thumbnail[]" id="thumbnail" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
    
                                                    <input placeholder="Thumbnail 2" type="file" name="thumbnail[]" id="thumbnail" autocomplete="thumbnail" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_user as $item)
                                                <input placeholder="Keunggulan" type="text" name="{{ ('advantage-users['.$item->id.']') }}" id="advantage-users" autocomplete="advantage-users" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ $item->advantage }}" required>
                                            @empty
                                                <input placeholder="Keunggulan 1" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>

                                                <input placeholder="Keunggulan 2" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>

                                                <input placeholder="Keunggulan 3" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>
                                            @endforelse
