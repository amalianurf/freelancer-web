            ...
            <div class="grid w-full gap-5 px-10 mx-auto md:grid-cols-12">
                ...
                <div class="col-span-4 lg:text-right">
                    <div class="relative mt-0 md:mt-6">
                        <a href="{{ route('member.service.destroy', $service->id) }}" class="px-4 py-2 mt-2 text-left text-white bg-red-400 rounded-xl" onclick="return confirm('Are you sure want to delete this service?')">
                            Delete Service
                        </a>
                    </div>
                </div>
                            ...
                            <div class="grid gap-5 md:grid-cols-12">
                                <main class="p-4 lg:col-span-7 md:col-span-12">
                                    ...
                                    <div class="p-3 my-4 bg-gray-100 rounded-lg image-gallery" x-data="gallery()">
                                        <img :src="featured" alt="thumbnail" class="rounded-lg cursor-pointer object-cover w-full h" style="height: 288px" data-lity>
                                        <div class="flex overflow-x-scroll hide-scroll-bar dragscroll">
                                            <div class="flex mt-2 flex-nowrap">
                                                @forelse ($thumbnail as $item)
                                                    <img :class="{'border-4 border-serv-button': active === {{ $item->id }}}" @click="changeThumbnail('{{ url(Storage::url($item->thumbnail)) }}', {{ $item->id }})" src="{{ url(Storage::url($item->thumbnail)) }}" alt="thumbnail" class="inline-block w-24 mr-2 rounded-lg cursor-pointer">
                                                @empty
                                                    {{-- empty --}}
                                                @endforelse
                                            </div>
