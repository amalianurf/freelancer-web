                    ...
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        <button class="flex flex-row items-center w-full px-4 py-2 mt-2 text-left bg-white rounded-lg dark-mode:bg-transparent dark-mode:focus:text-white dark-mode:hover:text-white dark-mode:focus:bg-gray-600 dark-mode:hover:bg-gray-600 md:w-auto md:inline md:mt-0 md:ml-4">
                            @if (auth()->user()->detail_user()->first()->photo != '')
                                <img class="inline w-12 h-12 mr-3 rounded-full" src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo)) }}" alt="user photo" />
                            @else
                                <svg class="inline w-12 h-12 mr-3 rounded-full bg-gray-100 text-gray-300" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div class="grid gap-5 md:grid-cols-12">
                <main class="p-4 lg:col-span-7 md:col-span-12 md:pt-0">
                    <div class="sm:grid sm:h-32 sm:grid-flow-row sm:gap-4 sm:grid-cols-3">
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{ asset('/assets/images/services-progress-icon.svg') }}" alt="progress-icon" class="w-8 h-8">
                                </div>
                        ...
                        <div class="flex flex-col justify-center px-4 py-4 mb-4 bg-white rounded-xl">
                            <div>
                                <div>
                                    <img src="{{ asset('/assets/images/services-completed-icon.svg') }}" alt="completed-icon" class="w-8 h-8">
                                </div>
                                ...
                                @forelse ($orders as $item)
                                    <tr class="text-gray-700">
                                            ...
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if ($item->client_user->detail_user->photo)
                                                        <img class="object-cover w-full h-full rounded-full" src="{{ url(Storage::url($item->client_user->detail_user->photo)) }}" alt="photo profile" loading="lazy" />
                                                    @else
                                                ...
                                                <div>
                                                    ...
                                                    @if ($item->status_order_id == '1')
                                                        <p class="text-sm text-green-400">{{ $item->status_order->name ?? '' }}</p>
                                                    @elseif ($item->status_order_id == '2')
                                                        <p class="text-sm text-yellow-400">{{ $item->status_order->name ?? '' }}</p>
                                                    @elseif ($item->status_order_id == '3')
                                                        <p class="text-sm text-blue-400">{{ $item->status_order->name ?? '' }}</p>
                                                    @elseif ($item->status_order_id == '4')
                                                        <p class="text-sm text-red-400">{{ $item->status_order->name ?? '' }}</p>
                                                    @else
                                                        <p class="text-sm text-black">{{ $item->status_order->name ?? '' }}</p>
                                                    @endif
                                                </div>
                                            </div>
                                        </td>
                                        <td class="w-2/4 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    @if (isset($item->service->thumbnail[0]->thumbnail))
                ...
                <aside class="p-4 lg:col-span-5 md:col-span-12 md:pt-0">
                    <div class="relative w-full h-56 m-auto text-white transition-transform transform bg-red-100 rounded-xl">
                        ...
                        <img class="relative object-cover w-full h-full rounded-xl" src="{{ asset('/assets/images/card-background.png') }}" alt="card-background">
                        ...
                        <div class="absolute w-full px-8 top-8">
                            <div class="flex justify-between">
                                ...
                                <img class="w-16 h-12" src="{{ asset('/assets/images/visa-icon.svg') }}" alt="visa-icon" />
                            </div>
                            <div class="pt-6">
                            ...
                            <tbody class="bg-white">
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="{{ url('https://randomuser.me/api/portraits/men/2.jpg') }}" alt="random user" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="{{ url('https://randomuser.me/api/portraits/men/3.jpg') }}" alt="random user" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">Sarah Roses</p>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="{{ url('https://randomuser.me/api/portraits/men/4.jpg') }}" alt="random user" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">Sarah Roses</p>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="{{ url('https://randomuser.me/api/portraits/men/5.jpg') }}" alt="random user" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">Sarah Roses</p>
                                ...
                                <tr class="text-gray-700">
                                    <td class="w-1/2 px-1 py-2">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                <img class="object-cover w-full h-full rounded-full" src="{{ url('https://randomuser.me/api/portraits/men/6.jpg') }}" alt="random user" loading="lazy" />
                                                <div class="absolute inset-0 rounded-full shadow-inner" aria-hidden="true"></div>
                                            </div>
                                            <div>
                                                <p class="font-medium text-black">Sarah Roses</p>
