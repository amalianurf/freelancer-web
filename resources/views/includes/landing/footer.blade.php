        ...
        <div class="sm:flex sm:mt-16">
            <div class="mt-8 sm:mt-0 sm:w-full flex flex-col md:flex-row justify-between">
                <div class="flex-1 mt-2 flex-col">
                    ...
                    <div class="my-3">
                        <a href="{{ route('landing.explore') }}" class="text-serv-text font-light">
                            Explore
                        </a>
                    </div>
                    <div class="my-3">
                ...
                <div class="flex-1 mt-2 flex-col lg:mr-28">
                    ...
                    <div class="my-3">
                        ...
                        <div class="flex flex-wrap w-full mt-4 relative h-15 hover:text-white bg-serv-email rounded-lg items-center mb-2 pr-5">
                            ...
                            <input
                                type="text"
                                class="flex-shrink flex-grow flex-auto w-px border-0 h-10 border-grey-light rounded rounded-l-none pr-3 self-center relative outline-none bg-serv-email  "
